 ...
 */
export function parseTopic(topic, namespace, ts = Date.now(), payload, publisher) {
    if (!topic.startsWith(`${namespace}/a2a/v1/`))
        return null;
    ...
    const base = { topic, namespace, ts, payload, publisher };
